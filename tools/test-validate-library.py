...
CASES = [
    ...
    ("forced subtitle in another language than its audio", False, lambda r: edit(man(episode(r)), lambda d: d["renditions"]["audio"][0].update(language="fre")), "paired with forced subtitle sub0 in another language", []),
